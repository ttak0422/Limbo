...
local function _1_(keybinds0)
  ...
  local norg_keymap_n = {}
  local norg_keymap_i = {}
  local norg_event_n = {{(leader .. "tu"), "core.qol.todo_items.todo.task_undone"}, {(leader .. "tp"), "core.qol.todo_items.todo.task_pending"}, {(leader .. "td"), "core.qol.todo_items.todo.task_done"}, {(leader .. "th"), "core.qol.todo_items.todo.task_on_hold"}, {(leader .. "tc"), "core.qol.todo_items.todo.task_cancelled"}, {(leader .. "tr"), "core.qol.todo_items.todo.task_recurring"}, {(leader .. "ti"), "core.qol.todo_items.todo.task_important"}, {(leader .. "ta"), "core.qol.todo_items.todo.task_ambiguous"}, {"<C-Space>", "core.qol.todo_items.todo.task_cycle"}, {(leader .. "nn"), "core.dirman.new.note"}, {"<CR>", "core.esupports.hop.hop-link"}, {"gd", "core.esupports.hop.hop-link"}, {"gf", "core.esupports.hop.hop-link"}, {"gF", "core.esupports.hop.hop-link"}, {">>", "core.promo.promote"}, {"<<", "core.promo.demote"}, {"lt", "core.pivot.toggle-list-type"}, {"li", "core.pivot.invert-list-type"}}
