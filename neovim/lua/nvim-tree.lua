...
local view = {cursorline = true, debounce_delay = 50, side = "left", signcolumn = "yes", width = {min = 30, max = -1, padding = 1}, float = {quit_on_focus_loss = true, enable = false}, preserve_window_proportions = false, centralize_selection = false, number = false, relativenumber = false}
local renderer
do
...
local diagnostics = {debounce_delay = 100, show_on_open_dirs = true, severity = {min = vim.diagnostic.severity.INFO, max = vim.diagnostic.severity.ERROR}, icons = {hint = "", info = "", warning = "", error = ""}, show_on_dirs = false, enable = false}
...
local actions
do
  local change_dir = {restrict_above_cwd = false, enable = false, global = false}
