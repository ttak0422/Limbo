...
dap_virt.setup({enabled_commands = true, highlight_changed_variables = true, show_stop_reason = true, commented = true, only_first_definition = true, display_callback = display_callback, virt_text_pos = virt_text_pos, virt_text_win_col = nil, clear_on_continue = false, all_frames = false, highlight_new_as_changed = false, all_references = false, enabled = false, virt_lines = false})
dap_hl.setup({})
