...
local opts = {helplang = "ja,en", mouse = "a", ignorecase = true, smartcase = true, hlsearch = true, incsearch = true, hidden = true, termguicolors = true, autoread = true, showmatch = true, completeopt = ("menu" .. "," .. "menuone" .. "," .. "preview"), number = true, signcolumn = "yes", virtualedit = "block", cmdheight = 0, laststatus = 3, showtabline = 2, undofile = true, undodir = (cache_path .. "/undo"), swapfile = true, directory = (cache_path .. "/swap"), winwidth = 20, winheight = 1, expandtab = true, tabstop = 2, shiftwidth = 2, foldcolumn = "1", foldlevel = 99, foldlevelstart = 99, foldenable = true, fillchars = "eob: ,fold: ,foldopen:\239\145\188,foldsep: ,foldclose:\239\145\160", backup = true, backupcopy = "yes", backupdir = (cache_path .. "/backup"), splitright = true, splitbelow = true, diffopt = "internal,filler,closeoff,vertical", cursorline = true, equalalways = false, startofline = false, showmode = false}
