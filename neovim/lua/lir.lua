...
local mappings = {e = actions.edit, l = actions.edit, ["<CR>"] = actions.edit, h = actions.up, q = actions.quit, ["<C-c>"] = actions.quit, a = actions.newfile, r = actions.rename, d = actions.delete}
local float
local function _1_()
