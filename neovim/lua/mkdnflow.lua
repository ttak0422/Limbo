...
local modules = {conceal = true, cursor = true, links = true, lists = true, maps = true, paths = true, tables = true, cmp = false, folds = false, bib = false, yaml = false, buffers = false}
...
links = {style = "markdown", context = 0, implicit_extension = nil, transform_explicit = _1_, name_is_source = false, conceal = false, transform_implicit = false}
