...
local win_options = {signcolumn = "number", foldcolumn = "0", conceallevel = 3, concealcursor = "nvic", cursorcolumn = false, wrap = false, spell = false, list = false}
