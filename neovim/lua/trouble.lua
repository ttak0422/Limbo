...
return M.setup({position = "bottom", height = 10, icons = true, mode = "document_diagnostics", fold_open = "\239\145\188", fold_closed = "\239\145\160", group = true, padding = true, multiline = true, indent_lines = true, win_config = {border = "none"}, auto_preview = true, keys = keys, auto_jump = auto_jump, include_declaration = include_declaration, signs = signs, auto_fold = false, auto_close = false, use_diagnostic_signs = false, cycle_results = false, auto_open = false})
