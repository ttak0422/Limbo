...
local completion = {enabled = true, postfix = enabled, chain = enabled, lazyResolveTextEdit = disabled, favoriteStaticMembers = favoriteStaticMembers, filteredTypes = filteredTypes, guessMethodArguments = "auto", importOrder = {"#", "java", "jakarta", "javax", "org", "com", ""}, matchCase = "firstletter", maxResults = 50}
